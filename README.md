...
Spotify is the dominant player in music streaming, and the case against it has only grown:

- **Artist exploitation.** Spotify's per-stream payouts are a fraction of a cent. Independent and mid-tier musicians describe the platform as structurally hostile to making a living from recorded music. The 2024 demonetization of tracks under 1,000 streams pushed the situation further: most working artists now earn literally nothing from a significant share of their catalog.
